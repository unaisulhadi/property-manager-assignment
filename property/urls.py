...
from .views import (
    ...
    PropertyRetrieveAPIView,
    UnitListByPropertyCreateAPIView,
    ListAllUnitsAPIView,
)
...
urlpatterns = [
    ...
    path(
        "properties/", PropertyListCreateAPIView.as_view(), name="property-list-create"
    ),
    path(
        "properties/<int:pk>/",
        PropertyRetrieveAPIView.as_view(),
        name="property-retrieve",
    ),
