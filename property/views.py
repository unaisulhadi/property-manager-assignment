...
class PropertyRetrieveAPIView(RetrieveAPIView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        return SuccessResponse(message="Property fetched successfully", data=serializer.data)
...
class UnitListByPropertyCreateAPIView(ListCreateAPIView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        return SuccessResponse(message="Units fetched successfully", data=serializer.data)
    ...
    def post(self, request, *args, **kwargs):
        ...
        if serializer.is_valid():
            serializer.save()
            return SuccessResponse(message="Unit created successfully", data=serializer.data)
